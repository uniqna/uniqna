    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hot', models.DecimalField(blank=True,
                                            decimal_places=7, default=1000.123, max_digits=11)),
                ('points', models.IntegerField(default=1)),
                ('solved', models.BooleanField(default=False)),
                ('flair_icon', models.CharField(max_length=25, null=True)),
                ('flair', models.CharField(max_length=180, null=True)),
                ('channels', models.ManyToManyField(
                    blank=True, to='post.Channel')),
                ('downs', models.ManyToManyField(
                    blank=True, related_name='question_downvotes', to=settings.AUTH_USER_MODEL)),
                ('ups', models.ManyToManyField(blank=True,
                                               related_name='question_upvotes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
